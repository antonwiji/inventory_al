...
--
-- Table structure for table `cc_harga`
--

CREATE TABLE `cc_harga` (
  `id` int(11) NOT NULL,
...
(2, 'Laporan Inventory 2022', '2022-06-05 15:00:28', 1);
...
(24, 2, 'cc_terima', 7, 0, '2022-06-05 00:00:00', 0, 'Data awal', 1),
(25, 2, 'cc_terima', 8, 0, '2022-06-05 00:00:00', 0, 'Data awal', 1),
(33, 2, 'cc_kirim', 3, 13, '2017-07-30 00:00:00', 65, 'Data sisa periode', 1),
(34, 2, 'cc_kirim', 6, 8, '2022-06-05 00:00:00', 100, 'minum', 1),
(35, 2, 'cc_kirim', 2, 13, '2022-06-05 00:00:00', 10, 'ajk', 1);
...
(1, 1, '2022-06-05 00:00:00', 800, 'Data awal periode', 1),
(2, 2, '2022-06-05 00:00:00', 150, 'Data awal periode', 1),
(3, 3, '2022-06-05 00:00:00', 485, 'Data awal periode', 1),
(4, 4, '2022-06-05 00:00:00', 400, 'Data awal periode', 1),
...
--
-- Indexes for table `cc_harga`
--
ALTER TABLE `cc_harga`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `cc_harga`
--
ALTER TABLE `cc_harga`
